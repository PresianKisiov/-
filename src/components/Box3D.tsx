          ...
          >
            ...
            <div className="space-y-3 relative z-10 bg-black/40 border border-white/5 p-3 rounded-2xl backdrop-blur-sm">
              ...
              <p className="text-[10px] text-zinc-400 leading-normal">
                Постави монети от 10, 20 или 50 цента и виж как се променя училищната класация.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <p className="text-[10px] sm:text-xs text-zinc-400 leading-relaxed">
                Да отделяш по няколко цента всеки ден ни учи на съпричастност и грижа за другите в нашето ежедневие.
              </p>
              <p className="text-[10px] sm:text-xs text-zinc-400 leading-relaxed">
